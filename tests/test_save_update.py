...
class TestConfig(unittest.TestCase):
    ...
    def test_migrate_from_old_config_only(self):
        ...
        old_cfg = {
            ...
            "size": "Large",
            "clients": [
                {"rowid": 0, "name": "Acme Corp", "type": "separator", "bg": None},
    ...
    def test_migrate_old_string_clients(self):
        ...
        old_cfg = {
            "clients": ["#Acme Corp", "Acme Calls", "Acme Tickets"],
        }
        with open(config._OLD_CONFIG_PATH, "w") as f:
            json.dump(old_cfg, f)
        ...
        self.assertEqual(rows[1]["name"], "Acme Calls")
    ...
    def test_migrate_collapsed_string_groups(self):
        ...
        old_cfg = {
            "clients": ["#Acme Corp", "Calls", "#ACME", "Tickets"],
            "collapsed_groups": ["#Acme Corp"],
        }
        with open(config._OLD_CONFIG_PATH, "w") as f:
            json.dump(old_cfg, f)
